...
/**
 * A class that represents a text document It does one pass through the document to count the number of syllables,
 * words, and sentences and then stores those values.
 *
...
public class EfficientDocument extends Document {
  ...
  /**
   * Passes through the text one time to count the number of words, syllables and sentences, and set the member
   * variables appropriately. Words, sentences and syllables are defined as described below.
   */
  ...
  /**
   * Get the number of words in the document. "Words" are defined as contiguous strings of alphabetic characters i.e.
   * any upper or lower case characters a-z or A-Z
   *
  ...
  /**
   * Get the number of sentences in the document. Sentences are defined as contiguous strings of characters ending in an
   * end of sentence punctuation (. ! or ?) or the last contiguous set of characters in the document, even if they don't
  ...
  /**
   * Get the number of syllables in the document. Words are defined as above.  Syllables are defined as: a contiguous
   * sequence of vowels, except for a lone "e" at the end of a word if the word has another set of contiguous vowels,
